...
import (
	...
	"github.com/SidGrip/eliopool-15.21-go/internal/chain"
)
...
func Parse(args []string) (*Config, error) {
	...
	fs.StringVar(&cfg.ParentRPCURL, "parent-rpc", chain.DefaultRPCURL(chain.ParentRPCUser, chain.ParentRPCPass, chain.Blakecoin.RPCPort), "Blakecoin parent daemon RPC URL")
	...
	fs.StringVar(&cfg.ProxyParentURL, "proxy-parent-rpc", fmt.Sprintf("http://auxpow:auxpow@127.0.0.1:%d/", chain.DefaultPoolJSONRPCPort), "pool JSON-RPC URL used by the merged-mining proxy")
