...
import (
	...
	chainparams "github.com/blakecoin/merged-mine-proxy/internal/chain"
...
func (s *Service) handleDashboardState(w http.ResponseWriter, r *http.Request) {
	...
	writeJSON(w, map[string]interface{}{
		...
		"mining_key_hrps": dashboardMiningKeyHRPs(),
...
func (s *Service) handleGenerateMiningKey(w http.ResponseWriter, r *http.Request) {
	...
	bundle, err := miningkey.GenerateV2Bundle(dashboardMiningKeyHRPs())
	if err != nil {
...
func (s *Service) handleVerifyMiningKey(w http.ResponseWriter, r *http.Request) {
	...
	writeJSON(w, map[string]interface{}{
		...
		"derived_addresses": miningkey.DeriveV2Addresses(miningKey, dashboardMiningKeyHRPs()),
	})
}
...
func dashboardMiningKeyHRPs() map[string]string {
